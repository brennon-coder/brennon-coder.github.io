$(function () {
  ...
  function setup() {
    ...
    createCollectable("database", 250, 0, 20, 0.8)
    createCollectable("database", 650, 500, 20, 0.8)
    createCollectable("database", 1000, 300, 20, 0.8)
    createCollectable("database", 150, 600, 20, 0.8)
    createCollectable("database", 1200, 0, 20, 0.8)
